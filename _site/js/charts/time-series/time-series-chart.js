...
//        .interpolate("monotone")
                .x(function (d) {
                    return time_scale(new Date(d.timestamp));
                })
                .y(function (d) {
        ...
        // legend
        var legendSize = {width: legend.width, height: (data3 ? 47 : (data2 ? 31 : 16))};
    ...
    chart.update = function (data1, data2, data3) {
        ...
        value_scale.domain([0,
            d3.max([
                ...
                d3.max(data2 ? data2 : [], function (d) {
                    return d.value
                }),
                d3.max(data3 ? data3 : [], function (d) {
                    return d.value
                })
            ])
        ]).nice();
